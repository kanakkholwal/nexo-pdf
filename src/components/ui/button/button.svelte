  ...
  export const buttonVariants = tv({
    ...
    variants: {
      ...
      size: {
        ...
        sm: "h-8 gap-1.5 rounded-md px-3 [&>svg]:size-4 text-xs font-medium",
        lg: "h-10 rounded-md px-6 [&>svg]:px-4 [&>svg]:size-5",
        xl: "h-12 rounded-md px-8 [&>svg]:px-5 [&>svg]:size-6 text-lg font-medium",
