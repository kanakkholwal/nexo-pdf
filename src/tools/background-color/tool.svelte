...
{:else}
  ...
  <div class="flex-1 overflow-y-auto bg-muted/10 p-6 space-y-8">
    <div class="max-w-md mx-auto space-y-8">
      ...
      <div class="rounded-xl border border-border bg-card p-6 shadow-sm space-y-6">
        ...
        <div class="space-y-4">
          <div class="space-y-2">
            ...
            />
            <p class="text-[10px] text-muted-foreground">Specify which pages should receive the background color.</p>
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                <span class="text-sm font-mono uppercase font-medium">{store.state.colorHex}</span>
                <span class="text-xs text-muted-foreground">Click the swatch to select a color</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="rounded-lg bg-blue-500/10 p-4 text-xs text-blue-600 dark:text-blue-400 leading-relaxed">
        <p><strong>How it works:</strong> Most PDF pages have a transparent background. This tool creates a solid color layer and places your existing document on top of it. Scanned documents or pages that already have a solid white background image embedded will block the new color.</p>
      </div>
